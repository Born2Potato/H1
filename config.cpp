...
class CfgVehicles
{
	...
	class uh1y_base: Helicopter_Base_F
	{
		...
		class Sounds
		{
			class Engine
			{
				sound[] = {"h1\sounds\ext-fly-mode2", db8, 1.0, 800};
				frequency = "rotorSpeed";
				volume = "camPos*((rotorSpeed-0.72)*4)";
			};
			class RotorLowOut
			{
				sound[] = {"h1\sounds\int-rotor-single5b", db8, 1.0, 1400};
				frequency = "rotorSpeed";
			...
			class RotorHighOut
			{
				sound[] = {"h1\sounds\int-rotor-single5a", db8, 1.0, 1600};
				frequency = "rotorSpeed";
  			...
  			class EngineIn
			{
				sound[] = {"h1\sounds\int-fly-mode7", db0, 1.0};
				frequency = "rotorSpeed";
			 	volume = "(1-camPos)*((rotorSpeed-0.75)*4)";
			};
			class RotorLowIn
			{
				sound[] = {"h1\sounds\int-rotor-single5b", db0, 1.0};
				frequency = "rotorSpeed";
				volume = "2*(1-camPos)*((rotorSpeed factor[0.3, 1.1]) min (rotorSpeed factor[1.1, 0.3]))";
			};
			class RotorHighIn
			{
				sound[] = {"h1\sounds\int-rotor-single5a", db0, 1.0};
				frequency = "rotorSpeed";
