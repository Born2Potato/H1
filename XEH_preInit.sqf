...
call tato_h1_flir_fnc_initVars;

tato_h1_flir_aspectRatio = getResolution # 4;
tato_h1_flir_pipEffectsHashMap = createHashMapFromArray [
  ["Normal", [0]],
  ["NVG", [1]],
  ["Ti", [2]],
...
tato_h1_flir_visionModeNamesHashMap = createHashMapFromArray [
  [[0], "DTV"],
  [[1], "NVG"],
...
tato_h1_flir_visionModesHashMap = createHashMapFromArray [
  [[0, -1], [0]],
  [[1, -1], [1]],
