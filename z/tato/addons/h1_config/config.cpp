...
class CfgNonAIVehicles
{
	...
	//Hellfire
	//114K
	class Proxyagm114k: ProxyWeapon
	{
		model="z\tato\addons\h1_hellfire\hellfire\agm114k.p3d";
		simulation="maverickweapon";
	};
	//114N
	class Proxyagm114n: ProxyWeapon
	{
		model="z\tato\addons\h1_hellfire\hellfire\agm114n.p3d";
		simulation="maverickweapon";
	};

	//M299
	class Proxyrail_ul: ProxyWeapon
	{
		model="z\tato\addons\h1_hellfire\pylons\rail_ul.p3d";
		simulation="pylonpod";
	};
	class Proxyrail_ur: ProxyWeapon
	{
		model="z\tato\addons\h1_hellfire\pylons\rail_ur.p3d";
		simulation="pylonpod";
	};
	class Proxyrail_ll: ProxyWeapon
	{
		model="z\tato\addons\h1_hellfire\pylons\rail_ll.p3d";
		simulation="pylonpod";
	};
	class Proxyrail_lr: ProxyWeapon
	{
...
class CfgVehicles
{
	...
	class ah1z_base: Helicopter_Base_F
	{
		// General Information
		faction = "BLU_F";
		model = "z\tato\addons\h1_ah1z\ah1z_viper.p3d";
		picture = "z\tato\addons\h1_uh1y\data\icon_uh1y.paa";
		icon = "z\tato\addons\h1_uh1y\data\icon_uh1y.paa";
		mapSize = 15;
		simulation = "helicopterRTD";
				...
				class TransportPylonsComponent 
				{
					...
					class pylons 
					{
						...
						class pylons4: pylons1
						{
							...
							attachment="agm114k_lr";
							UIposition[]={0.69999999,0.51999998};
							priority=4;
						};
						...
						{
							attachment="lau61ga_m151_zoneA";
							UIposition[]={0.5,0.37};
							priority=3;
						};
						class pylons6: pylons2
						{
							attachment="lau61ga_m151_zoneB";
							UIposition[]={0.5,0.41999999};
							priority=2;
						};
						class pylons7: pylons3
						{
							attachment="lau61ga_m151_zoneC";
							UIposition[]={0.5,0.47};
							priority=1;
						};
						...
						class pylons12: pylons4
						{
							attachment="";
							UIposition[]={0.30000001,0.51999998};
							priority=1;
						};
						...
						class pylons14: pylons2
						{
							attachment="agm114k_ur";
							UIposition[]={0.1,0.41999999};
							priority=2;
						};
						class pylons15: pylons3
						{
							attachment="agm114k_ll";
							UIposition[]={0.1,0.47};
							priority=1;
						};
						class pylons16: pylons4
						{
							attachment="agm114k_lr";
