...
class cfgSoundShaders 
{
	...
	{
		samples[] = {{"z\tato\addons\h1_sounds\sounds\turbine_ext_close.ogg",1}};
	...
	{
		samples[] = {{"z\tato\addons\h1_sounds\sounds\turbine_int.ogg",1}};
		frequency = "rotorspeed * (1-rotorthrust/15) * 1.25";
	...
	{
		samples[] = {{"z\tato\addons\h1_sounds\sounds\rotor_ext_close.ogg",1}};
	...
	{
		samples[] = {{"z\tato\addons\h1_sounds\sounds\rotor_int.ogg",1}};
		frequency = "rotorspeed * (1-rotorthrust/15) * 1.25";
	...
	{
		samples[] = {{"z\tato\addons\h1_sounds\sounds\rotor_ext_distance.ogg",1}};
		frequency = "rotorspeed * (1-rotorthrust/15) * 1";
	...
	{
		samples[] = {{"z\tato\addons\h1_sounds\sounds\turbine_ext_distance.ogg",1}};
		frequency = "rotorspeed * (1-rotorthrust/15) * 1.25";
